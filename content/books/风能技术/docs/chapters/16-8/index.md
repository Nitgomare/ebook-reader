...
![455_490_738_652_858_0.jpg](images/455_490_738_652_858_0.jpg)
...
$$
y = \left( {{K}_{\mathrm{p}} + \frac{{K}_{\mathrm{i}}}{s} + \frac{{K}_{\mathrm{d}}s}{1 + s{T}_{\mathrm{d}}}}\right) x \tag{8.1}
$$
...
![461_246_1094_1147_363_0.jpg](images/461_246_1094_1147_363_0.jpg)
...
$$
{Q}_{\mathrm{a}} = \frac{1}{2}{\rho A}{C}_{\mathrm{q}}{U}^{2}R = \frac{1}{2}{\rho \pi }{R}^{3}\frac{{C}_{\mathrm{p}}}{\lambda }{U}^{2} \tag{8.2}
$$

由 $U = {\Omega R}/\lambda$ 得

$$
{Q}_{\mathrm{a}} = \frac{1}{2}{\rho \pi }{R}^{5}\frac{{C}_{\mathrm{p}}}{{\lambda }^{3}}{\Omega }^{2} \tag{8.3}
$$

因此,在稳态时,可以通过设定的发电机转矩 ${Q}_{\mathrm{g}}$ 达到最佳叶尖速比,以平衡机械转矩, 如下式所示:

$$
{Q}_{\mathrm{g}} = \frac{1}{2}\frac{{\pi \rho }{R}^{5}{C}_{\mathrm{p}}}{{\lambda }^{3}{G}^{3}}{\omega }_{\mathrm{g}}^{2} - {Q}_{\mathrm{L}} \tag{8.4}
$$
...
$$
{Q}_{\mathrm{g}} = \frac{1}{2}\frac{{\pi \rho }{R}^{5}{C}_{\mathrm{p}}}{{\lambda }^{3}{G}^{3}}{\omega }_{2}^{\mathrm{g}} - {Q}_{\mathrm{L}} - B{\omega }_{\mathrm{g}} \tag{8.5}
$$

对于刚性传动系统，忽略变流器的动态特性，转矩平衡方程为

$$
I\dot{\Omega } = {Q}_{\mathrm{a}} - G{Q}_{\mathrm{g}} \tag{8.6}
$$

![463_186_209_1262_668_0.jpg](images/463_186_209_1262_668_0.jpg)
...
$$
\left( {I - {G}^{2}B}\right) \dot{\Omega } = {Q}_{\mathrm{a}} - \frac{1}{2}\frac{{\pi \rho }{R}^{5}{C}_{\mathrm{p}}}{{\lambda }^{3}{G}^{2}}{\omega }_{\mathrm{g}}^{2} + G{Q}_{\mathrm{L}} \tag{8.7}
$$
...
$$
{Q}_{\mathrm{a}} = \frac{1}{2}{\rho A}{C}_{\mathrm{q}}R{U}^{2} = \frac{1}{2}{\rho \pi }{R}^{5}{\Omega }^{2}{C}_{\mathrm{q}}/{\lambda }^{2} \tag{8.8}
$$

式中, $R$ 为风力发电机组的半径; $\Omega$ 为转速; ${C}_{\mathrm{q}}$ 为转矩系数。如果忽略传动轴的变形, 则机械转矩的简单估算式为

$$
{Q}_{\mathrm{a}}^{ * } = G{Q}_{\mathrm{g}} + I\dot{\Omega } = G{Q}_{\mathrm{g}} + {IG}{\dot{\omega }}_{\mathrm{g}} \tag{8.9}
$$

式中, $I$ 为总转动惯量。更精确的估算式应该把传动轴的变形等也考虑进去。由此可以估算出方程 $F\left( \lambda \right)  = {C}_{\mathrm{q}}\left( \lambda \right) /{\lambda }^{2}$ 为

$$
{F}^{ * }\left( \lambda \right)  = \frac{{Q}_{\mathrm{a}}^{ * }}{\frac{1}{2}{\rho \pi }{R}^{5}{\left( G{\omega }_{\mathrm{g}}\right) }^{2}} \tag{8.10}
$$

由稳态动力分析得到函数 $F\left( \lambda \right)$ ,就可以推导出当前的叶尖速比 ${\lambda }^{ * }$ 。最佳叶尖速比时的发电机转速可以由下面的公式计算出来:

$$
{\omega }_{\mathrm{d}} = {\omega }_{\mathrm{g}}\widehat{\lambda }/{\lambda }^{ * } \tag{8.11}
$$
...
$$
{\delta F} = \frac{\partial F}{\partial \beta }{\delta \beta } =  - {D}_{\mathrm{p}}\dot{x} \tag{8.13}
$$

$$
{\delta \beta } = \frac{-{D}_{\mathrm{p}}}{\partial F/\partial \beta }\dot{x}
$$
...
![467_199_1121_1249_923_0.jpg](images/467_199_1121_1249_923_0.jpg)
...
![470_214_206_1269_553_0.jpg](images/470_214_206_1269_553_0.jpg)
...
![470_409_1411_881_505_0.jpg](images/470_409_1411_881_505_0.jpg)
...
![471_247_895_1142_326_0.jpg](images/471_247_895_1142_326_0.jpg)
...
![472_463_206_767_451_0.jpg](images/472_463_206_767_451_0.jpg)
...
$$
\left\lbrack  \begin{array}{l} {L}_{\mathrm{d}} \\  {L}_{\mathrm{q}} \end{array}\right\rbrack   = \frac{2}{3}\left\lbrack  \begin{array}{lll} \cos \varphi & \cos \left( {\varphi  + {2\pi }/3}\right) & \cos \left( {\varphi  + {4\pi }/3}\right) \\  \sin \varphi & \sin \left( {\varphi  + {2\pi }/3}\right) & \sin \left( {\varphi  + {4\pi }/3}\right)  \end{array}\right\rbrack  \left\lbrack  \begin{array}{l} {L}_{1} \\  {L}_{2} \\  {L}_{3} \end{array}\right\rbrack
$$

其中, $\varphi$ 为方位角,上述过程的逆运算为

$$
\left\lbrack  \begin{array}{l} {\theta }_{1} \\  {\theta }_{2} \\  {\theta }_{3} \end{array}\right\rbrack   = \left\lbrack  \begin{matrix} \cos \varphi & \sin \varphi \\  \cos \left( {\varphi  + {2\pi }/3}\right) & \sin \left( {\varphi  + {2\pi }/3}\right) \\  \cos \left( {\varphi  + {4\pi }/3}\right) & \sin \left( {\varphi  + {4\pi }/3}\right)  \end{matrix}\right\rbrack  \left\lbrack  \begin{array}{l} {\theta }_{d} \\  {\theta }_{q} \end{array}\right\rbrack
$$

其中, $\theta$ 代表在这种情况下的桨距角,上述转换关系还可以扩展至任意多个叶片 $B$ , 计算公式如下:

$$
\left\lbrack  \begin{array}{l} {L}_{\mathrm{d}} \\  {L}_{\mathrm{q}} \end{array}\right\rbrack   = \frac{2}{B}\left\lbrack  \begin{matrix} \cos \varphi & \cos \left( {\varphi  + {2\pi }/B}\right) & \cos \left( {\varphi  + {4\pi }/B}\right) & \cdots \\  \sin \varphi & \sin \left( {\varphi  + {2\pi }/B}\right) & \sin \left( {\varphi  + {4\pi }/B}\right) & \cdots \\   & & &  \end{matrix}\right\rbrack  \left\lbrack  \begin{array}{l} {L}_{1} \\  {L}_{2} \\  {L}_{3} \\  \vdots  \end{array}\right\rbrack
$$

$$
\left\lbrack  \begin{matrix} {\theta }_{1} \\  {\theta }_{2} \\  {\theta }_{3} \\  \vdots  \end{matrix}\right\rbrack   = \left\lbrack  \begin{matrix} \cos \varphi & \sin \varphi \\  \cos \left( {\varphi  + {2\pi }/B}\right) & \sin \left( {\varphi  + {2\pi }/B}\right) \\  \cos \left( {\varphi  + {4\pi }/B}\right) & \sin \left( {\varphi  + {4\pi }/B}\right) \\  \vdots & \vdots  \end{matrix}\right\rbrack  \left\lbrack  \begin{matrix} {\theta }_{\mathrm{d}} \\  {\theta }_{\mathrm{q}} \end{matrix}\right\rbrack
$$

对于一个两叶片风力机来说, 这个计算可以简化如下:

$$
{L}_{\mathrm{d}} = \left( {{L}_{1} - {L}_{2}}\right) \cos \varphi ,\;{L}_{\mathrm{q}} = \left( {{L}_{1} - {L}_{2}}\right) \sin \varphi ,
$$

$$
{\theta }_{1} =  - {\theta }_{2} = {\theta }_{\mathrm{d}}\cos \varphi  + {\theta }_{\mathrm{q}}\sin \varphi
$$
...
$$
\left\lbrack  \begin{array}{l} {\theta }_{\mathrm{d}} \\  {\theta }_{\mathrm{q}} \end{array}\right\rbrack   = \left\lbrack  C\right\rbrack  \left\lbrack  \begin{array}{l} {L}_{\mathrm{d}} \\  {L}_{\mathrm{d}} \end{array}\right\rbrack
$$
...
![477_181_687_1275_519_0.jpg](images/477_181_687_1275_519_0.jpg)
...
![478_213_472_1277_895_0.jpg](images/478_213_472_1277_895_0.jpg)
...
![479_223_227_1198_676_0.jpg](images/479_223_227_1198_676_0.jpg)

图 8.11 $1\mathrm{P}$ 和 $2\mathrm{P}$ 独立变桨距控制对非旋转载荷的影响

![479_188_1055_1260_283_0.jpg](images/479_188_1055_1260_283_0.jpg)
...
![482_332_1543_1038_483_0.jpg](images/482_332_1543_1038_483_0.jpg)

图 8.13 典型的线性化风力机模型

![483_325_316_984_166_0.jpg](images/483_325_316_984_166_0.jpg)
...
$$
{Y}^{\prime }\left( s\right)  = H\left( s\right) \left\lbrack  {X\left( s\right)  - {Y}^{\prime }\left( s\right) }\right\rbrack \tag{8.15}
$$
...
$$
{H}^{\prime }\left( s\right)  = \frac{H\left( s\right) }{1 + H\left( s\right) }
$$
...
$$
H\left( s\right)  = \frac{B\left( s\right) }{A\left( s\right) } \tag{8.18}
$$
...
$$
Y\left( s\right)  = \frac{B\left( s\right) }{A\left( s\right)  + B\left( s\right) }X\left( s\right)  = \frac{k{B}^{\prime }\left( s\right) }{A\left( s\right)  + k{B}^{\prime }\left( s\right) }X\left( s\right) \tag{8.19}
$$
...
![484_547_544_601_389_0.jpg](images/484_547_544_601_389_0.jpg)
...
![484_401_1335_891_733_0.jpg](images/484_401_1335_891_733_0.jpg)
...
$$
y = {K}_{\mathrm{p}}\left( {1 + \frac{1}{s{T}_{\mathrm{i}}}}\right) x \tag{8.20}
$$
...
$$
\frac{1 + s/{\omega }_{1}}{1 + s/{\omega }_{2}} \tag{8.22}
$$
...
![488_388_790_917_406_0.jpg](images/488_388_790_917_406_0.jpg)
...
![490_335_923_1027_516_0.jpg](images/490_335_923_1027_516_0.jpg)
...
$$
x\left( k\right)  = {x}^{\prime }\left( k\right)  + L\left\lbrack  {y\left( {k - 1}\right)  - {y}^{\prime }\left( {k - 1}\right) }\right\rbrack
$$
...
$$
v = {C}_{\mathrm{v}}x + {D}_{\mathrm{v}}u
$$
...
$$
P = {C}_{\mathrm{v}}^{T}R{C}_{\mathrm{v}}\;\text{ 且 }\;Q = {D}_{\mathrm{v}}^{T}R{D}_{\mathrm{v}} + S
$$
...
$$
{y}_{\mathbf{k}} = F{y}_{\mathbf{k} - 1} + \left( {1 - F}\right) {x}_{\mathbf{k}}
$$
...
$$
\frac{\omega }{\tan \left( {{\omega T}/2}\right) }\frac{1 - {z}^{-1}}{1 + {z}^{-1}}
$$
...
![496_360_1095_967_159_0.jpg](images/496_360_1095_967_159_0.jpg)

例如,一个使用了双线性变换进行离散化的 $\mathrm{{PI}}$ 控制器近似为

$$
y = {K}_{\mathrm{p}}\left\lbrack  {\left( {T/2{T}_{\mathrm{i}} + 1}\right)  + \left( {T/2{T}_{\mathrm{i}} - 1}\right) {z}^{-1}}\right\rbrack   \cdot  \frac{1}{1 - {z}^{-1}}x = R\left( z\right) I\left( z\right) x
$$

为了避免积分器饱和, 可以按照以下的方法来实现:

$$
\Delta {y}_{k} = {K}_{p}\left\lbrack  {\left( {T/2{T}_{\mathrm{i}} + 1}\right) {x}_{k} + \left( {T/2{T}_{\mathrm{i}} - 1}\right) {x}_{k - 1}}\right\rbrack  \left\lbrack  {R\left( z\right) \text{ 的实现 }}\right\rbrack
$$
