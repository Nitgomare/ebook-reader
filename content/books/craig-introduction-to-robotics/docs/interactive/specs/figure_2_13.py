...
@media (max-width: 720px) {
  ...
  .readout { font-size: 11.5px; line-height: 1.42; padding: 5px 7px; }
  .readout .small { font-size: 10px; }
  .matrix {
    right: 8px; top: 84px; bottom: auto; left: 8px; width: auto;
    font-size: 9.5px; line-height: 1.3; padding: 5px 7px;
  }
  .matrix + .matrix { top: 196px; bottom: auto; }
...
<div class="matrix" id="matrixT">
  ...
  <div class="row"><span class="b">[</span> <span class="r" id="a00">0.866</span>  <span class="r" id="a01">-0.500</span>  <span class="r" id="a02">0.000</span>   <span class="t" id="a03">10.000</span> <span class="b">]</span></div>
  <div class="row"><span class="b">[</span> <span class="r" id="a10">0.500</span>  <span class="r" id="a11">0.866</span>   <span class="r" id="a12">0.000</span>   <span class="t" id="a13">5.000</span> <span class="b">]</span></div>
  <div class="row"><span class="b">[</span> <span class="r" id="a20">0.000</span>  <span class="r" id="a21">0.000</span>   <span class="r" id="a22">1.000</span>   <span class="t" id="a23">0.000</span> <span class="b">]</span></div>
  <div class="row"><span class="b">[</span> <span class="h" id="a30">0</span>      <span class="h" id="a31">0</span>       <span class="h" id="a32">0</span>       <span class="h" id="a33">1</span>     <span class="b">]</span></div>
</div>

<div class="matrix" id="matrixInv">
  <div class="cap">ᴮ_AT = ᴬ_BT⁻¹（式2-45，例2.5 式2-47）</div>
  <div class="row"><span class="b">[</span> <span class="inv" id="b00">0.866</span>  <span class="inv" id="b01">0.500</span>   <span class="inv" id="b02">0.000</span>   <span class="t" id="b03">-4.964</span> <span class="b">]</span></div>
  <div class="row"><span class="b">[</span> <span class="inv" id="b10">-0.500</span> <span class="inv" id="b11">0.866</span>   <span class="inv" id="b12">0.000</span>   <span class="t" id="b13">-0.598</span> <span class="b">]</span></div>
  <div class="row"><span class="b">[</span> <span class="inv" id="b20">0.000</span>  <span class="inv" id="b21">0.000</span>   <span class="inv" id="b22">1.000</span>   <span class="t" id="b23">0.000</span> <span class="b">]</span></div>
  <div class="row"><span class="b">[</span> <span class="h" id="b30">0</span>      <span class="h" id="b31">0</span>       <span class="h" id="b32">0</span>       <span class="h" id="b33">1</span>     <span class="b">]</span></div>
...
(function () {
  ...
  function fillMatrix(prefix, M) {
    for (var i = 0; i < 16; i += 1) {
      var cell = document.getElementById(prefix + (i < 10 ? "0" : "") + i);
      if (cell) cell.textContent = FK.format(M[i], 3);
    }
  }
